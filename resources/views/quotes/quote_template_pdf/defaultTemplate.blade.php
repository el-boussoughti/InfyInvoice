...
<table width="100%">
    <tr>
        <td class="header-left">
            <div class="main-heading" {{ $styleCss }}="font-size: 40px">{{ __('messages.quote.quote_name') }}</div>
            <div class="invoice-number font-color-gray">{{ __('messages.quote.quote_id').':' }}&nbsp;#{{ $quote->quote_id }}</div>
                ...
                @if(isset($quote) && !empty($quote))
                    @foreach($quote->quoteItems as $key => $quoteItems)
                        <tr>
                            ...
                            <td class="number-align"><b class="euroCurrency">{{isset($quoteItems->price) ? getCurrencyAmount($quoteItems->price,true): __('messages.common.n/a')}}</b></td>
