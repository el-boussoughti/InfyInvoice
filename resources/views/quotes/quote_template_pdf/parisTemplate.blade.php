...
<table width="100%">
    <tr>
        <td colspan="2">
            ...
            {{$styleCss}}="border-bottom: 10px solid {{ $invoice_template_color }}">{{ __('messages.quote.quote_name') }}
            </div>
...
<table width="100%">
    ...
    <tr>
        <td class="vertical-align-top">
            <strong {{$styleCss}}="color: {{ $invoice_template_color }}">{{ __('messages.common.from') }}</strong><br>
            ...
            <strong class="tu">{{ __('messages.quote.quote_id').':' }}&nbsp;</strong>#{{ $quote->quote_id }}<br>
