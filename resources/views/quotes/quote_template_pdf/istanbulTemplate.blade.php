...
<table width="100%">
    <tr>
        <td>
            <div class="main-heading p-3" {{ $styleCss }}="font-size: 40px;background: {{ $invoice_template_color }}
            ; color: white">{{ __('messages.quote.quote_name') }}</div>
            <div class="logo">
    ...
    <tr class="invoice-items">
        <td colspan="2">
            <table class="items-table">
                <thead {{ $styleCss }}="border-top: 1px solid ; border-bottom: 1px solid ">
                <tr class="tu">
                    <th>#</th>
                ...
                @if(isset($quote) && !empty($quote))
                    @foreach($quote->quoteItems as $key => $quoteItems)
                        <tr>
                            ...
                            <td class="number-align"><b class="euroCurrency">{{isset($quoteItems->total) ? getCurrencyAmount($quoteItems->total,true):  __('messages.common.n/a')}}</b></td>
                        </tr>
                    @endforeach
                @endif
                        </tbody>
