        ...
        <table class="" width="100%">
            <tr>
                <td class="header-left">
                    ...
                    <div class="logo"><img width="90px" src="{{ getLogoUrl() }}" alt=""></div>
                </td>
            </tr>
        </table>
        <br>
        <table width="100%">
            <thead>
                <tr class="align-bottom">
                    <td style="width: 70%" class="vertical-align-top">
                    ...
                    @if (!empty($invoice->paymentQrCode))
                        <td style="width: 30%" class="text-center">
                            <strong
                                style=""><b>{{ __('messages.payment_qr_codes.payment_qr_code') }}</b></strong><br>
