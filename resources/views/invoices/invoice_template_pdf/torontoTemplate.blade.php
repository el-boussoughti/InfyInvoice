...
<body>
    ...
    <table class="w-100">
        <tr class="invoice-items">
            ...
            <td class="number-align" style="border-bottom: 1px solid {{ $invoice_template_color }}; padding: 5px;"><b
                    class="euroCurrency">
                    {{ isset($invoiceItems->price) ? getInvoiceCurrencyAmount($invoiceItems->price, $invoice->currency_id, true) : __('messages.common.n/a') }}</b>
            </td>
            <td class="number-align" style="border-bottom: 1px solid {{ $invoice_template_color }}; padding: 5px;">
            ...
            <td class="number-align"
                style="border-bottom: 1px solid {{ $invoice_template_color }}
                                    ; padding: 5px;">
                <b class="euroCurrency">
    ...
    <tr>
        <td colspan="2" class="vertical-align-bottom">
            ...
            <strong {{ $styleCss }}="color: {{ $invoice_template_color }};">
                {{ __('messages.common.regards') . ':' }}</strong>
            <br>{{ $setting['app_name'] }}
        </td>
    </tr>
    </table>
