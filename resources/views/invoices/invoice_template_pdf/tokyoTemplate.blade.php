...
;border-bottom: 15px solid {{ $invoice_template_color }}">
            ...
            <tr class="invoice-items">
                <td colspan="2">
                    <table class="items-table">
                        <thead
                            {{ $styleCss }}="border-top: 1px solid {{ $invoice_template_color }};border-bottom: 1px solid {{ $invoice_template_color }}">
                            <tr class="tu">
                                <th>#</th>
        ...
        <tr>
            <td colspan="2" class="vertical-align-bottom">
                ...
                <br><span
                    {{ $styleCss }}="color: {{ $invoice_template_color }}">{{ $setting['app_name'] }}</span>
            </td>
        </tr>
        </table>
    </div>
