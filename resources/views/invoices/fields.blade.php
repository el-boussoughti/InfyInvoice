    ...
    <div class="mb-0">
        <div class="row mb-2">
            ...
            <div class="mb-5 col-lg-3 col-sm-12">
                ...
                {{ Form::select('payment_qr_code_id', $paymentQrCode, array_key_first($paymentQrCode) ?? null, ['class' => 'form-select io-select2 payment-qr-code', 'data-control' => 'select2', 'placeholder' => 'Select Payment QR Code']) }}
            </div>
            <div class="mb-5 col-lg-6 col-sm-12">
