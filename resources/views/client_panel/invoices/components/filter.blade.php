            ...
            <div class="dropdown-menu py-0" aria-labelledby="clientInvoiceFilterBtn">
                ...
                <div class="p-5">
                    <div class="mb-5">
                        ...
                        {{ Form::select('status',collect($filterHeads[0])->sortBy('key')->reverse()->toArray(), \App\Models\Invoice::STATUS_ALL
        ,['class' => 'form-control form-control-solid form-select', 'data-control'=>"select2", 'id' => 'clientInvoiceStatus']) }}
                    </div>
