...
class InvoiceRepository extends BaseRepository
{
    ...
    public function getSyncList($invoice = [])
    {
        ...
        $data['paymentQrCode'] = PaymentQrCode::whereIsDefault('1')->pluck('title', 'id')->toArray() ?? null;
    ...
    public function prepareEditFormData($invoice): array
    {
        ...
        $paymentQrCodes = PaymentQrCode::whereId($invoice->payment_qr_code_id)->pluck('title', 'id')->toArray();
